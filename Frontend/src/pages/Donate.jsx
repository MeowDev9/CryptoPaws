                ...
                <div className="donate-columns">
                    ...
                    <div className="donate-column">
                        <img
                            src="/images/case.jpg"
                            alt="Donate by Case"
                            className="background-image-donate"
                        />
                        <div className="overlay"></div>
                        <div className="text-content">
                            <h2>Donate by Case</h2>
                            <p>
                                Help specific animals in urgent need by donating directly to their
                                rescue and medical care.
                            </p>
                            <Link to="/donate2"><button className="view-button">View Cases</button></Link>
                        </div>
                    </div>
                    ...
                    <div className="donate-column">
                        ...
                        <div className="text-content">
                            ...
                            <p>
                                Support trusted animal welfare organizations in their efforts to
